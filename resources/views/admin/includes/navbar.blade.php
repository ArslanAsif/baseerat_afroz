            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="">
                    <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                        <img src="{{ isset(Auth::user()->avatar) ? url('/images/users/'.Auth::user()->avatar) : url('/images/user.jpg') }}" alt="User DP">{{ Auth::user()->name }}
                ...
                {{--<li role="presentation" class="dropdown">--}}
                    ...
                    {{--<ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">--}}
                        {{--<li><a><span class="image"><img src="images/img.jpg" alt="Profile Image" /></span>--}}
                            {{--<span><span>John Smith</span><span class="time">3 mins ago</span>--}}
                            {{--</span>--}}
                            {{--<span class="message">--}}
