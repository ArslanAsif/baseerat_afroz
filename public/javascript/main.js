        ...
        menuWidthDetect: function(winWidth) {
            ...
            if ( currMenuType !== responsiveMenu.menuType ) {
                ...
                if ( currMenuType === 'mobile' ) {
                    ...
                    $('#mainnav-mobi').children('.menu').append('<li class="added"><div id="search-form-menu"><form action="/search" method="post"><input name="search" type="text" class="search-text-menu" id="search-text-menu"></form></div><div class="social-mobi"><a href="#"><i class="fa fa-facebook"></i></a><a href="#"><i class="fa fa-twitter"></i></a><a href="#"><i class="fa fa-google-plus"></i></a><a href="#"><i class="fa fa-linkedin"></i></a></div></li>');
